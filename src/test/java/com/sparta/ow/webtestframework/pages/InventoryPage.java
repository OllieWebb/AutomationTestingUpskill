...
public class InventoryPage {
    ...
    public void addItemToBasket1() {
        webDriver.findElement(itemToBasket1).click();
    }

    public void addItemToBasket2() {
        webDriver.findElement(itemToBasket2).click();
    }

    public Integer getBasketCount() {
        try {
            return Integer.valueOf(webDriver.findElement(basketCount).getText());
